...
const { parseJSON, createRandomString } = require('../../helpers/utiliteis');
                                        ...
                                        if (!err3) {
                                            ...
                                            data.update('users', userPhone, userObject, (err4) => {
                                                if (!err4) {
                                                    ...
                                                    callback(500, {
                                                        error: 'Thew was a problem in the server side',
                                                    });
                                                }
                                            });
                                        } else {
                                    ...
                                    data.read(
                                        ...
                                        (err3, userData) => {
                                            ...
                                            if (!err3 && userData) {
                                                ...
                                                // remove the delete checd id from user's list of checks
